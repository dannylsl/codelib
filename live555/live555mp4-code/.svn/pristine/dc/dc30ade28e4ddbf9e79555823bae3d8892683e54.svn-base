...
#include "../liveMedia/include/MPEG4VideoStreamDiscreteFramerffmpeg.hh"
//#include "MPEG4FrameSource.hh"
#include "MPEG4FrameParserffmpeg.h"

MPEG4VideoStreamDiscreteFramerffmpeg*
MPEG4VideoStreamDiscreteFramerffmpeg::createNew(UsageEnvironment& env,
        char const* inputSource) {
    // Need to add source type checking here???  #####
    return new MPEG4VideoStreamDiscreteFramerffmpeg(env, inputSource);
}

MPEG4VideoStreamDiscreteFramerffmpeg
::MPEG4VideoStreamDiscreteFramerffmpeg(UsageEnvironment & env,
        char const* inputSource)
: MPEG4FrameSource(env, inputSource),
...
MPEG4VideoStreamDiscreteFramerffmpeg::~MPEG4VideoStreamDiscreteFramerffmpeg() {
}

void MPEG4VideoStreamDiscreteFramerffmpeg::doGetNextFrame() {
...
void MPEG4VideoStreamDiscreteFramerffmpeg
::afterGettingFrame(void* clientData, unsigned frameSize,
        unsigned numTruncatedBytes,
        struct timeval presentationTime,
        unsigned durationInMicroseconds) {
    MPEG4VideoStreamDiscreteFramerffmpeg* source = (MPEG4VideoStreamDiscreteFramerffmpeg*) clientData;
...
Boolean MPEG4VideoStreamDiscreteFramerffmpeg::getNextFrameBit(u_int8_t& result) {
...
Boolean MPEG4VideoStreamDiscreteFramerffmpeg::getNextFrameBits(unsigned numBits,
        u_int32_t& result) {
    result = 0;
...
void MPEG4VideoStreamDiscreteFramerffmpeg::analyzeVOLHeader() {
