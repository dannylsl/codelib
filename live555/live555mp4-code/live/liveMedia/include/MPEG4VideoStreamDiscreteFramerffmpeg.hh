...
class MPEG4VideoStreamDiscreteFramerffmpeg : public MPEG4FrameSource {
public:
    static MPEG4VideoStreamDiscreteFramerffmpeg*
    createNew(UsageEnvironment& env, char const* inputSource);

protected:
    MPEG4VideoStreamDiscreteFramerffmpeg(UsageEnvironment& env,
            char const* inputSource);
    // called only by createNew()
    virtual ~MPEG4VideoStreamDiscreteFramerffmpeg();
    MPEG4FrameSource* fInputSource;
protected:
