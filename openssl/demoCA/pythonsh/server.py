...
#	restsize = 1054
#	restsize = 404
	restsize = os.path.getsize("./demoCA/pythonsh/"+filename)
...
#	ADDR = ('192.168.213.204',10100)
	...
	while True:
		...
		child = pexpect.spawn("sudo openssl ocsp -index ../index.txt -CA ./demoCA/cacert.pem -rsigner ./demoCA/cacert.pem -rkey ./demoCA/private/cakey.pem -port 9999")
		#child = pexpect.spawn('openssl ca -in %s -out %s' % ( filename, "./usercert.pem"))
		child.logfile = sys.stdout
		child.expect('Enter pass phrase for')
		child.send('123456\n')
